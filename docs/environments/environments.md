...
![Create an environment](./img/create-environment-screenshot.png)
...
![List of environments](./img/list-environments-screenshot.png)

### Edit
![List of environments](./img/edit-environment-screenshot.png)
You can:
- edit the colour
- set if it's the default environment

### Deleting an evironment
At time of writing, it's not possible to remove an environment. Please if you'd like to delete one.
